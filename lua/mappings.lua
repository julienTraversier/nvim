...
map("n", "<A-left>", require("nvchad.tabufline").prev, { desc = "Prev tab" })
map("n", "<A-right>", require("nvchad.tabufline").next, { desc = "Next tab" })
map("n", "<A-h>", require("nvchad.tabufline").prev, { desc = "Prev tab" })
map("n", "<A-l>", require("nvchad.tabufline").next, { desc = "Next tab" })
map("n", "<A-c>", require("nvchad.tabufline").close_buffer, { desc = "close current tab" })
...
map("n", "<c-t>", function()
  require("nvchad.term").toggle {
    pos = "float",
    id = "xz",
    float_opts = { relative = "win", row = 2, col = 2  }
  }
